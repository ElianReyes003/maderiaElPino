			...
			<div class="bg-white rounded-lg shadow-lg p-4">
				...
				<div class="mt-10">
					...
					<div class="grid grid-cols-2 text-justify mt-10">
						<h2 class="font-semibold">Fecha: <p class="font-normal">{{$compra->fecha}}</p>
						</h2>
						...
						<h2 class="font-semibold ">Por saldar: <p class="font-normal">{{$compra->cantidadASaldar}}</p>
						</h2>
						<h2 class="font-semibold md:ml-[20rem] ml-10">Semanas Deuda: <p class="font-normal">{{$compra->diasDeuda}}</p>
						</h2>
						<h2 class="font-semibold">Articulo(s): <p class="font-normal">{{$compra->nombreArticulo}}</p>
						</h2>
						<h2 class="font-semibold md:ml-[20rem] ml-10">Enganche: <p class="font-normal">{{$compra->enganche}}</p>
						</h2>
						<h2 class="font-semibold">Valor: <p class="font-normal">{{$compra->cantidadTipoVenta}}</p>
						</h2>
						<h2 class="font-semibold md:ml-[20rem] ml-10">Folio: <p class="font-normal">{{$compra->folioCompra}}</p>
						</h2>
