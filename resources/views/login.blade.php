...
<body>
    <div class=" w-full h-screen bg-no-repeat bg-cover" style="background-image: url('https://images.pexels.com/photos/122588/pexels-photo-122588.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1');">
                           ...
                           <div>
                            ...
                            <div class="grid grid-cols-1 mt-10">
                                <form class="max-w-sm mx-auto">
                                    ...
                                    <input type="text" name="nombreUsuario" id="website-admin" class="rounded-none rounded-e-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-green-400 focus:border-green-400 block flex-1 min-w-0 w-full text-sm p-2.5" placeholder="">
                                    </div>
                                    <!-- contra -->
                                    <div class="mt-5">
                                        ...
                                        <input type="password" name="contraseña" id="website-admin" class="rounded-none rounded-e-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-green-400 focus:border-green-400 block flex-1 min-w-0 w-full text-sm p-2.5" placeholder="">
                                        </div>
                                    </div>
                                </form>             
                            </div>
                            ...
                            <div class="md:p-10 p-5 mt-5 flex justify-center">
                                <div class="flex justify-center">
                                  ...
                                  <button type="submit" class="flex items-center justify-center px-4 h-10 md:px-10 ms-3 text-base font-medium text-white bg-green-600 border rounded-lg hover:bg-green-500">
                                    Iniciar sesion
                                  </button>
                                </div>
                          </div>
    ...
    <div class="flex justify-end p-5 mt-10 align-bottom">
